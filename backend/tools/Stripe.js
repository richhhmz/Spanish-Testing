...
import { isDebug, STRIPE_SECRET_KEY } from '../config.js';
...
export async function getStripeSubscriptionPayments() {
  console.log('[getStripeSubscriptionPayments] begin');
  const rows = [];
  ...
  console.log('[getStripeSubscriptionPayments] end');
  return rows;
}
